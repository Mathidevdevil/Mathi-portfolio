            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                ...
                >
                    ...
                    <div className="space-y-4 md:space-y-6">
                        ...
                        <div className="p-4 md:p-6 border border-cyan/30 rounded-lg bg-cyan/5 backdrop-blur-sm relative">
                            ...
                            <h3 className="text-cyan dark:text-neon font-bold mb-3 md:mb-4 flex items-center gap-2 text-sm md:text-base">
                                <Award size={18} className="md:w-5 md:h-5" />
                                Certification Status
                            </h3>
                            <div className="text-xs md:text-sm font-mono text-gray-700 dark:text-gray-300 space-y-1">
                    ...
                    <div className="space-y-4">
                        {userData.about.education.map((edu, index) => (
                            ...
                            >
                                ...
                                <span className="text-cyan font-mono text-sm">{edu.year}</span>
                                <h4 className="text-xl font-bold mt-1 text-gray-900 dark:text-white group-hover:text-cyan dark:group-hover:text-neon transition-colors">
                                    {edu.degree || edu.role}
                                </h4>
                                <p className="text-gray-600 dark:text-gray-500 text-sm mb-2">{edu.institution}</p>
                                <p className="text-gray-500 dark:text-gray-400 font-mono text-xs">{edu.details}</p>
                            </motion.div>
                        ))}
                    </div>
                </motion.div>
